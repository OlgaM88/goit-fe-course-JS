...
const sizesCheck= document.querySelectorAll('input[name=size]:checked');
const arrSizes = Array.from(sizesCheck).map(el => filter.size.push(el.value));

const colorCheck= document.querySelectorAll('input[name=color]:checked');
const arrColor = Array.from(colorCheck).map(el => filter.color.push(el.value));

const realeseCheck= document.querySelectorAll('input[name=release_date]:checked');
